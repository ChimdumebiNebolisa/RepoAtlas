...
import capturedOutput from "@/data/examples/click-candidate-brief.json";
...
const repositoryUrl = "https://github.com/pallets/click";
const commit = "2c8cd3ac958a7eb316d67f2d316c27086c4c0369";
const sourceBaseUrl = `${repositoryUrl}/blob/${commit}/`;

const title = "Click Python Candidate Brief Example | RepoAtlas";
const description =
  "Read a complete, exact-commit Candidate Brief for Pallets Click with all eight interview sections and links to the Python source evidence behind each claim.";
...
export default function ClickCandidateBriefExamplePage() {
  return (
      ...
      <article>
        <header className="guide-hero example-hero click-example-hero page-container">
          <div className="guide-hero-copy example-hero-copy click-example-hero-copy">
            <p className="eyebrow">Python repository example</p>
            <h1>A Candidate Brief for Click, pinned to one commit.</h1>
            <p>
              RepoAtlas analyzed the public Pallets Click repository without running its code.
            ...
            <Link
              ...
              href="/?source=click_example#analyze"
            >
              Analyze your repository
            </Link>
          </div>

          <aside className="comparison-entrance example-snapshot click-example-snapshot" aria-label="Captured report details">
            <span>Captured output</span>
            <h2>Pallets Click</h2>
            <dl>
              <div>
                <dt>Repository</dt>
                <dd><a href={repositoryUrl}>pallets/click</a></dd>
              </div>
              <div>
                <dt>Commit</dt>
